...
- Modify `README.md` and `docs/TRACEABILITY_MATRIX.md`: record exact delivered scope and remaining graph work.
...
- [ ] **Step 3: Add the minimal projection and verifier**
...
- [ ] **Step 4: Run the focused and archive suites**
...
- [ ] **Step 3: Implement bounded append-only revisions**
...
- [ ] **Step 3: Implement immutable TypeScript contracts and adapters**
...
- [ ] **Step 3: Wire the minimum state flow**
...
- [ ] **Step 4: Preserve the workbench layout**
...
- [ ] **Step 5: Run component and application tests**
...
- [ ] **Step 1: Add a failing browser E2E assertion**
...
- [ ] **Step 2: Run E2E and confirm the new assertion**
...
- [ ] **Step 4: Run the complete release-quality gate**
...
```bash
git add e2e/source-workbench.spec.ts README.md docs/TRACEABILITY_MATRIX.md
